<%@page import="com.hwj.hospital.util.MTimeUtil"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.*"%>
<%@ page import="com.hwj.hospital.entity.*" %>
<%@ page import="com.hwj.hospital.entity.Employee" %>
<%@ page import="com.hwj.hospital.entity.Department" %>
<%@ page import="com.hwj.hospital.entity.Position" %>
